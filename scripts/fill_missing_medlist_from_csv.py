...
Usage examples:
  python scripts/fill_missing_medlist_from_csv.py --csv src/data/TBF.csv           # dry run
  python scripts/fill_missing_medlist_from_csv.py --csv src/data/TBF.csv --commit  # apply
  python scripts/fill_missing_medlist_from_csv.py --csv src/data/TBF.csv --limit 50 --verbose
  python scripts/fill_missing_medlist_from_csv.py --csv src/data/TBF.csv --commit --price-divisor 89500
"""
...
def main():
    ...
    parser.add_argument("--csv", required=False, default=os.path.join("src", "data", "TBF.csv"), help="Path to CSV file")
