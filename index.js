...
const nssfOperationRoutes = require("./src/routes/nssfOperationRoutes");
const nssfCoverageRoutes = require("./src/routes/nssfCoverageRoutes");
...
const responsiblePartyMappingRoutes = require("./src/routes/responsiblePartyMappingRoutes");
...
app.use("/nssf-operations", nssfOperationRoutes);
app.use("/nssf-coverage", nssfCoverageRoutes);
...
app.use("/responsibleParty-mapping", responsiblePartyMappingRoutes);
